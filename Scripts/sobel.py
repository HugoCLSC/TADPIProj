...
class Sobel():
    ...
    def __init__(self,  t1, t2):
        ...
        self.t1  =t1
        self.t2 = t2
        # self.resultImage = self.GPUCalc(image, t1, t2)
    ...
    def setup(self):
        try:
            ...
            _file = open(os.getcwd() + "\\Scripts\\sobel.cl", "r")
    ...
    def GPUCalc(self, image:np.ndarray):
        try:
            ...
            kernelName.set_arg(2, np.int32(self.t1))
            kernelName.set_arg(3, np.int32(self.t2))
